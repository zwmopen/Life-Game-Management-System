          ...
          if (baseType === 'fox') {
            ...
            if (type === 'bee') {
              ...
              for (let i = 0; i < 3; i++) {
                ...
                stripe.position.y = 0.5 + (i - 1) * 0.15;
              ...
              const eye1 = new THREE.Mesh(eyeGeometry, eyeMaterial);
              eye1.position.set(0.07, 0.55, 0.35);
              group.add(eye1);
              ...
              proboscis.position.set(0, 0.45, 0.38);
              ...
              wing1.position.set(0.12, 0.65, 0);
              wing1.rotation.x = Math.PI / 8;
              wing1.rotation.z = Math.PI / 10;
              wing1.castShadow = true;
              group.add(wing1);
              
              const wing2 = new THREE.Mesh(wingGeometry, wingMaterial);
              wing2.position.set(-0.12, 0.65, 0);
              wing2.rotation.x = Math.PI / 8;
              ...
              hindWing1.position.set(0.1, 0.55, -0.05);
              hindWing1.rotation.x = Math.PI / 10;
              hindWing1.rotation.z = Math.PI / 6;
              group.add(hindWing1);
              
              const hindWing2 = new THREE.Mesh(hindWingGeometry, wingMaterial);
              hindWing2.position.set(-0.1, 0.55, -0.05);
              hindWing2.rotation.x = Math.PI / 10;
              ...
              for (let i = 0; i < 2; i++) {
                ...
                stripe.position.y = 0.5 + (i - 0.5) * 0.22;
                stripe.castShadow = true;
                stripe.receiveShadow = true;
                group.add(stripe);
              }
              ...
              thorax.position.set(0, 0.55, 0.15);
              ...
              const eyeGeometry = new THREE.SphereGeometry(0.05, 16, 16);
              const eye1 = new THREE.Mesh(eyeGeometry, eyeMaterial);
              eye1.position.set(0.1, 0.6, 0.42);
              group.add(eye1);
              
              const eye2 = new THREE.Mesh(eyeGeometry, eyeMaterial);
              eye2.position.set(-0.1, 0.6, 0.42);
              group.add(eye2);
              ...
              proboscis.position.set(0, 0.5, 0.45);
              proboscis.rotation.x = Math.PI / 6;
              group.add(proboscis);
              ...
              const wing1 = new THREE.Mesh(wingGeometry, wingMaterial);
              wing1.position.set(0.15, 0.65, 0);
              wing1.rotation.x = Math.PI / 8;
              ...
              const wing2 = new THREE.Mesh(wingGeometry, wingMaterial);
              wing2.position.set(-0.15, 0.65, 0);
              wing2.rotation.x = Math.PI / 8;
              ...
              const hindWing1 = new THREE.Mesh(hindWingGeometry, wingMaterial);
              hindWing1.position.set(0.12, 0.55, -0.05);
              hindWing1.rotation.x = Math.PI / 10;
              hindWing1.rotation.z = Math.PI / 5;
              group.add(hindWing1);
              
              const hindWing2 = new THREE.Mesh(hindWingGeometry, wingMaterial);
              hindWing2.position.set(-0.12, 0.55, -0.05);
              hindWing2.rotation.x = Math.PI / 10;
