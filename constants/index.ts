...
export const INITIAL_HABITS = [
  ...
  },
  {
    ...
    logs: {},
    priority: 'low' as const,
    note: '1. 大声朗读 ZWM 2.0 核心肯定语：我是 ZWM 2.0，人生游戏的唯一开发者，主动迭代，绝不回滚，所有愿望皆在行动中显化\n2. 调动「已拥有一切」的积极情绪，保持饱满状态\n3. 执行要求：声音洪亮，情绪饱满，完成后立即进入首个时间盒任务',
    reminder: {
      enabled: true,
      time: '07:25',
      repeat: 'daily' as const
