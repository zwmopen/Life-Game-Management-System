...
export const SHOP_CATALOG: ShopItem[] = [
  ...
  { id: 's_food_4', name: '红牛', description: '提神醒脑，补充能量', cost: 6, type: 'leisure', owned: false, icon: <Coffee size={24} className="text-yellow-500"/>, category: '饮食', image: 'https://images.unsplash.com/photo-1527960669566-f882ba85a4c6?w=400&h=400&fit=crop' },
  { id: 's_food_6', name: '随机选择一个小地方探索', description: '解渴又提神', cost: 99, type: 'leisure', owned: false, icon: <Coffee size={24} className="text-blue-500"/>, category: '饮食', image: 'https://images.unsplash.com/photo-1527960669566-f882ba85a4c6?w=400&h=400&fit=crop' },
