...
当我在对话中提出新的项目需求或修改要求时，请立即将这些最新的项目要求准确、记录或者跟新到对应位置到project_rules.md文档中。确保所有内容按照统一格式进行组织，包括需求提出时间、具体要求描述、优先级以及相关说明。此操作的目的是建立持续更新的项目规范文档，确保团队所有成员和AI能够随时查阅最新的项目要求，避免需求理解偏差，保障项目开发过程始终符合预期方向。
